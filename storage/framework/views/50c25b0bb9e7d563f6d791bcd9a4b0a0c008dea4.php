  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="<?php echo e(url('/admin/perusahaan')); ?>">
          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Raffi\penjualan-laravel\resources\views/admin/pages/perusahaan/index.blade.php ENDPATH**/ ?>